...
<html>
	...
	<body style="margin:0 15px 0 15px;">
		...
		<div id="jive-forumpage">
					...
					<tr valign="top">
						<td width="98%">
							<p class="jive-breadcrumbs">
								...
								<!-- 切换模式 -->
								<a style="color:blue;float:right;margin-right:10px;" href="article">切换到树状模式</a>
							</p>
					...
					<tbody>
						<tr>
							...
							<td class="jive-icon-label">
								<a id="jive-post-thread" href="post?sign=${1 }">发表新主题</a>
          ...
          <a href="articleFlat?currentPage=${1 }">首页</a>
          <a href="articleFlat?currentPage=${pages.getCurrentPage() - 1 }">上一页</a>
          <a href="articleFlat?currentPage=${pages.getCurrentPage() + 1 }">下一页</a>
           <a href="articleFlat?currentPage=${pages.getTotalPage() }">尾页</a>
           ] </span> </span>
						</td>
					</tr>
				</tbody>
										...
										<tbody>
											<tr class="">
												...
												<td nowrap="nowrap" width="1%">
													...
													<!-- 删除 -->
													<a href="deleteFlat?rootid=${ar.getRootid() }">删除</a>
												</td>

												<td class="jive-thread-name" width="95%">
													<a id="jive-thread-1" href="articleDetailFlat?id=${ar.getId() }&title=${ar.getTitle() }">${ar.getTitle() }</a>
												</td>
