				...
				<tr valign="top">
					<td width="98%">
						...
						<form action="articleSearch" method="post">
							...
							<input style="color: white; background: blue;" type="submit"
								value="文章搜索">
						</form> <!-- 退出按钮 --> <a style="color: blue; float: right;" href="exit">退出</a>
						<!-- 切换模式 --> <a
						style="color: blue; float: right; margin-right: 10px;"
										...
										<tbody>
											<tr class="">
												...
												<td nowrap="nowrap" width="1%">
													<!-- 更新 --> <a
													href="modify?id=${ar.getId() }&title=${ar.getTitle()}&cont=${ar.getCont()}">更新</a>
													<!-- 删除 --> <a
													href="delete?id=${ar.getId() }&pid=${ar.getPid() }&isleaf=${ar.getIsleaf() }">删除</a>

												</td>

												<td class="jive-thread-name" width="95%"><a
													id="jive-thread-1"
													href="articleDetail?rootid=${ar.getRootid()}&title=${ar.getTitle() }">${ar.getTitle() }</a>
												</td>
												...
												<td class="jive-last" nowrap="nowrap" width="1%"><fmt:formatDate
														value="${ar.getPdate() }" pattern="yyyy-MM-dd HH:mm:ss" />
													<br>
