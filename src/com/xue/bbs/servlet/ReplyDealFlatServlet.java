 ...
 *
 */
@WebServlet("/replyDealFlat")
public class ReplyDealFlatServlet extends HttpServlet {
	//声明一个发布文章bean
	private ReplyDealFlat replyDealFlat = null;
	
	private static final long serialVersionUID = 1L;
       
    public ReplyDealFlatServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (loginStatus != null && loginStatus.equals("success")) {
			...
			if (title != "" && cont != "") {
				...
				request.getRequestDispatcher("/WEB-INF/jsp/replyDealFlat.jsp").forward(request, response);
			}
